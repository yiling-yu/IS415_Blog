...
* The R-squared of 0.003494 reveals that the simple regression model built is able to explain about 0.34% of the resale_price, which is pretty low. The negative coefficient of floor_area_sqm can also tell that this method is bad at explaining the resale_price as it is counter-intuitive to say the bigger the floor_area_sqm, the lower the resale_price.
...
* With reference to the report above, it is clear that all the independent variables are statistically significant. Thus we will keep them all.
